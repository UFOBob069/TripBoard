          ...
          <div className="mt-4 pt-4 border-t border-gray-100">
            ...
            <form onSubmit={handleAddComment} className="flex gap-2">
              <input
                ...
                className="flex-1 min-w-0 px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
              />
              <button
                type="submit"
                className="flex-shrink-0 px-4 py-2 bg-primary-500 text-white text-sm font-medium rounded-lg hover:bg-primary-600 transition-colors"
              >
                Post
              </button>
            </form>
